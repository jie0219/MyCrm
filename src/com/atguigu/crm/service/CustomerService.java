...
public class CustomerService {
	...
	public void updateStatus(Integer custId) {
		customerMapper.updateStatus(custId);		
	}
	public List<Dict> getLevel() {
		return customerMapper.getLevel();
	}
	public List<Dict> getCredit() {
		return customerMapper.getCredit();
	}
	public List<Dict> getSatify() {
		return customerMapper.getSatify();
	}
